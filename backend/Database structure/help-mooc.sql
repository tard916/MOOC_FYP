...
CREATE TABLE `admin` (
  `id` int(11) NOT NULL,
  `adm_uniqueID` varchar(50) NOT NULL,
...
INSERT INTO `admin` (`id`, `adm_uniqueID`, `name`, `email`, `password`) VALUES
(1, 'ADM_000000001', 'Admin', 'admin1@helpmooc.com', '$2y$10$s35A50tJEOWBxx7PBNs82OM2.uvq4.coxrqw.aUToA00LSGx9MUrS'),
(2, 'ADM_000000002', 'Admin', 'admin2@helpmooc.com', '$2y$10$s35A50tJEOWBxx7PBNs82OM2.uvq4.coxrqw.aUToA00LSGx9MUrS');
...
CREATE TABLE `course_cirriculum` (
  ...
  `status` varchar(5) NOT NULL DEFAULT 'show',
...
INSERT INTO `course_cirriculum` (`id`, `week_number`, `title`, `file_name`, `type`, `path`, `status`, `course_id`) VALUES
(1, 1, 'Model View Controler (MVC) with PHP part 1', 'New Social Network - Part 1 - Getting Started.mp4', 'Video', './src/courses/Model View Controler (MVC) with PHP/courseContent/New Social Network - Part 1 - Getting Started.mp4', 'show', 'CRS5c4eb123cbbbe9.91086078'),
(2, 1, 'Intro to MVC', 'Anttonen_Jevgeni.pdf', 'Article', './src/courses/Model View Controler (MVC) with PHP/courseContent/Anttonen_Jevgeni.pdf', 'show', 'CRS5c4eb123cbbbe9.91086078'),
(3, 2, 'Model View Controler (MVC) with PHP part 2 and 3', 'New Social Network - Part 2 - Creating Accounts.mp4', 'Video', './src/courses/Model View Controler (MVC) with PHP/courseContent/New Social Network - Part 2 - Creating Accounts.mp4', 'show', 'CRS5c4eb123cbbbe9.91086078'),
(4, 3, 'Model View Controler (MVC) with PHP part 4', 'New Social Network - Part 4 - Logging in Users.mp4', 'Video', './src/courses/Model View Controler (MVC) with PHP/courseContent/New Social Network - Part 4 - Logging in Users.mp4', 'show', 'CRS5c4eb123cbbbe9.91086078'),
(5, 4, 'Model View Controler (MVC) with PHP part 5', 'New Social Network - Part 5 - Login Tokens.mp4', 'Video', './src/courses/Model View Controler (MVC) with PHP/courseContent/New Social Network - Part 5 - Login Tokens.mp4', 'show', 'CRS5c4eb123cbbbe9.91086078'),
(6, 5, 'Model View Controler (MVC) with PHP part 6', 'New Social Network - Part 6 - Token Swap & Email Check.mp4', 'Video', './src/courses/Model View Controler (MVC) with PHP/courseContent/New Social Network - Part 6 - Token Swap & Email Check.mp4', 'show', 'CRS5c4eb123cbbbe9.91086078'),
(7, 6, 'Model View Controler (MVC) with PHP part 7', 'New Social Network - Part 7 - Logging out.mp4', 'Video', './src/courses/Model View Controler (MVC) with PHP/courseContent/New Social Network - Part 7 - Logging out.mp4', 'show', 'CRS5c4eb123cbbbe9.91086078'),
(8, 7, 'Model View Controler (MVC) with PHP part 8', 'New Social Network - Part 8 - Changing Passwords.mp4', 'Video', './src/courses/Model View Controler (MVC) with PHP/courseContent/New Social Network - Part 8 - Changing Passwords.mp4', 'show', 'CRS5c4eb123cbbbe9.91086078'),
...
ALTER TABLE `admin`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `adm_uniqueID` (`adm_uniqueID`);
